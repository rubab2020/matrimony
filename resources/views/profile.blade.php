			...
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-12">
					<div class="cover-photo">
			    		<img src="https://images.unsplash.com/photo-1470100568678-c2bc2ba890c1?ixlib=rb-1.2.1&auto=format&fit=crop&w=667&q=80">
					</div>
			    <div class="profile-section-card">
		        	<img class="profile-pic" src="https://pbs.twimg.com/media/CdbiubzVIAANj8J.jpg">
			        <div class="profile-name-container">
		            <div class="user-name">#AccountId</div>
			    ...
			    <div class="section-card">
          		...
          		<div class="col-6">
          			<div class="row attribute">
          				<div class="col-5 attribute-title">Annal Income:</div>
				...
				<div class="col-lg-3 col-md-4 col-12">
					...
					<div class="list-group">
					  ...
					  <a href="#" class="list-group-item list-group-item-action profiles">
					    <div class="row">
					    	<div class="col-4">
					    		<img class="profile-pic-sm" src="https://pbs.twimg.com/media/CdbiubzVIAANj8J.jpg">
					    	</div>
					    	<div class="col-8">
