					...
					<div class="col-12">
						...
						<div class="card">
							<div class="row">
								<div class="col-4">
									<div class="card profile-card">
										<img src="https://images.unsplash.com/photo-1494894578460-6707508a7fd0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
											alt="profile-sample1" class="background" />
										<a href="{{ url('/profile') }}">
											<img src="https://images.unsplash.com/photo-1494894578460-6707508a7fd0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
												alt="profile-image" class="profile rounded-full" />
										...
										<div class="card-content">
											<h2>
												<a href="{{ url('/profile') }}">Sarah Ali</a>
												<small>Private Service Holder</small>
											</h2>
										</div>
									</div>
								...
								<div class="col-8">
									<div class="card-block">
										...
										<hr>
										<p class="card-description">I have completed MBA from the Dhaka university. I am
											doing the job at a Govt Bank. Now I am looking for a sensible life partner.
										</p>
										<br>
										<!-- <a href="#" class="btn btn-primary btn-sm float-right">Read More</a> -->
									</div>
						...
						<div class="card">
							<div class="row">
								<div class="col-4">
									<div class="card profile-card">
										<img src="https://images.unsplash.com/photo-1484610521293-09126439f43f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
											alt="profile-sample1" class="background" />
										<a href="{{ url('/profile') }}">
											<img src="https://images.unsplash.com/photo-1484610521293-09126439f43f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60"
												alt="profile-image" class="profile rounded-full" />
